<div class="sidebar col-md-4"><!--Start Sidebar -->
    <div class="row">
        <div class="inner_sidebar"><!--Start Inner Sidebar -->
            ...
            <?php if ($this->uri->segment(2) == 'posts' || $this->uri->segment(2) == 'categories') { ?>
                <div class="widget widget_categories"><!-- Start widget categories -->
                    <h4 class="widget_title">Categories</h4>
                    <ul class="categories">
                        <?php
                        if (!empty($categorycount)) {
                            foreach ($categorycount as $cc) {
                                ?>
                                <li><a href="<?php echo base_url('web/categories/index/' . $cc->slug) ?>"><?php echo $cc->category ?> <span>(<?php echo $cc->postcount ?>)</span></a><i class="fa fa-angle-double-right"></i></li>
                                    <?php
                                }
                            }
                            ?>
