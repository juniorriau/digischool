...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url('public/uploads/' . $this->config->item('site_icon')) ?>">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3 class="text-center mt-0 m-b-15">
                                            <a href="<?php echo base_url() ?>" class="logo logo-admin"><img src="<?php echo base_url('public/uploads/' . $this->config->item('site_logo')) ?>" width="50%" alt="logo"></a>
                                        </h3>
                                            ...
                                            <form method="post" class="form-horizontal m-t-20" action="<?php echo $action ?>">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="emailaddress" name="emailaddress" class="form-control" type="text"  placeholder="emailaddress">
                                                    </div>
                                                </div>

                                                <div class="form-group text-center row m-t-20">
                                                    <div class="col-12">
                                                        <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Forgot</button>
                                                    </div>
                                                </div>
