    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header ">
                <div class="row">
                    <div class="col-3">
                        <?php echo anchor(site_url('app/students/create'), 'Create', 'class="btn btn-primary"'); ?>
                    </div>
                    <div class="col-lg-6">
                        <?php echo $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; ?>
                    </div>
                    <div class="col-3">
                        <form action="<?php echo site_url('app/students/index'); ?>" class="form-inline" method="get">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    if ($q <> '') {
                                        ?>
                                        <a href="<?php echo site_url('app/students'); ?>" class="btn btn-warning">Reset</a>
                                        <?php
                                    }
                                    ?>
