        ...
        <div class="card m-b-30">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="longtext">Comment Status <?php echo form_error('commentstatus') ?></label>
                        <select name="commentstatus" id="commentstatus" class="form-control">
                            <option value="1" <?php echo $commentstatus == "1" ? 'selected' : '' ?>>Open</option>
                            <option value="0" <?php echo $commentstatus == "0" ? 'selected' : '' ?>>Closed</option>
                        </select>
                    </div>
                </div>
                <div class="card-footer">
                    ...
                    <a href="<?php echo site_url('app/posts') ?>" class="btn btn-warning">Cancel</a>
                </div>
            </form>
        </div>
    </div> <!-- end col -->
